...
class Rol extends BaseDatos{
    ...
    public function cargar(){
        ...
        if($this->Iniciar()){// inicializa la conexion
            ...
            $this->setMensaje("Error en la Tabla rol").$this->getError();
        }// fin else
    ...
    public function insertar(){
        ...
        if($this->Iniciar()){
            if($this->Ejecutar($sql)){
                ...
                $this->setMensaje("rol - > Insertar").$this->getError();
            }// fin else
    ...
    public function modificar(){
        ...
        if($this->Iniciar()){
            if($this->Ejecutar($sql)){
                ...
                $this->setMensaje("Tabla rol Modificar ").$this->getError();
    ...
    public function eliminar(){
        ...
        if($this->Iniciar()){
            if($this->Ejecutar($sql)){
                ...
                $this->setMensaje("Tabla rol-> eliminar".$this->getError()); 
            }// fin else
